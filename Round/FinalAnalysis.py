...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -1)
worksheet.write(nbHM+2, 2, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -1)
worksheet.write(nbHM+3, 2, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -1)
worksheet.write(nbHM+4, 2, rounded_madMSD, int_format)
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -2)
worksheet.write(nbHM+2, 4, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -2)
worksheet.write(nbHM+3, 4, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -2)
worksheet.write(nbHM+4, 4, rounded_madMSD, int_format)
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -1)
worksheet.write(nbHM+2, 7, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -1)
worksheet.write(nbHM+3, 7, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -1)
worksheet.write(nbHM+4, 7, rounded_madMSD, int_format)
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -2)
worksheet.write(nbHM+2, 9, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -2)
worksheet.write(nbHM+3, 9, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -2)
worksheet.write(nbHM+4, 9, rounded_madMSD, int_format)
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -3)
worksheet.write(nbHM+2, 2, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -3)
worksheet.write(nbHM+3, 2, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x!= 0.0])
rounded_madMSD = round(madMSD, -3)
worksheet.write(nbHM+4, 2, rounded_madMSD, int_format)
for i in range(2, 5):
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -1)
worksheet.write(nbHM+2, 1, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -1)
worksheet.write(nbHM+3, 1, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -1)
worksheet.write(nbHM+4, 1, rounded_madMSD, int_format)
...
medMSD = statistics.median(x for x in aDataCol if x != 0.0)
rounded_medMSD = round(medMSD, -1)
worksheet.write(nbHM+2, 8, rounded_medMSD, int_format)
stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0)
rounded_stdMSD = round(stdMSD, -1)
worksheet.write(nbHM+3, 8, rounded_stdMSD, int_format)
madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0])
rounded_madMSD = round(madMSD, -1)
worksheet.write(nbHM+4, 8, rounded_madMSD, int_format)
...
for i in range(3, 7):
    ...
    medMSD = statistics.median(x for x in aDataCol if x != 0.0 and x != 5.0)
    rounded_medMSD = round(medMSD, -3)
    worksheet.write(nbHM+2, i+1, rounded_medMSD, int_format)
    stdMSD = statistics.stdev(x for x in aDataCol if x != 0.0 and x != 5.0)
    rounded_stdMSD = round(stdMSD, -3)
    worksheet.write(nbHM+3, i+1, rounded_stdMSD, int_format)
    madMSD = statistics.median([abs(x - medMSD) for x in aDataCol if x != 0.0 and x != 5.0])
    rounded_madMSD = round(madMSD, -3)
    worksheet.write(nbHM+4, i+1, rounded_madMSD, int_format)
